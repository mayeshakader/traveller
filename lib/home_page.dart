...
import 'package:projectone/colors.dart';
...
class _HomePageoneState extends State<HomePageone> with TickerProviderStateMixin{
    ...
    child:
        Row(
         ...
         children: [
           ...
           AppText(text:"see all",color:AppColors. textColor),
         ],
        )
        ),
          SizedBox(height:10,
