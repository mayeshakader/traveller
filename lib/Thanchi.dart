...
class Thanchi extends StatefulWidget {
  const Thanchi({Key? key }) :super(key: key);

  @override
  _ThanchiState createState() => _ThanchiState();
}

class  _ThanchiState extends State<Thanchi> {
  int gottenStars = 4;
  int selectedIndex = -1;
  int basePrice = 1000;
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage("img/thanchi.jpg"),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
