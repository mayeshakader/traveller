...
class Bandorbon extends StatefulWidget {
  const Bandorbon ({Key? key }) :super(key: key);

  @override
  _BandorbonState createState() => _BandorbonState();
}

class  _BandorbonState extends State<Bandorbon > {
  int gottenStars = 4;
  int selectedIndex = -1;
  int basePrice = 1000;
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage("img/bandorbon .jpg"),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
