...
class Tagindon extends StatefulWidget {
  const Tagindon({Key? key }) :super(key: key);

  @override
  _TagindonState createState() => _TagindonState();
}

class  _TagindonState extends State<Tagindon> {
  int gottenStars = 4;
  int selectedIndex = -1;
  int basePrice = 1000;
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage("img/tajigdon.jpg"),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
