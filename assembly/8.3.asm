...
.DATA
    MESSAGE1 DB 'Enter the value of M = $'
    MESSAGE2 DB 0DH, 0AH, 'Enter the value of N = $'
    MESSAGE3 DB 0DH, 0AH, 'The GCD of M and N is = $'
...
MAIN PROC
    ...
    LEA DX, MESSAGE1             ; load and display the string MESSAGE1
    MOV AH, 9
    INT 21H
    ...
    LEA DX, MESSAGE2             ; load and display the string MESSAGE2
    MOV AH, 9
    INT 21H
    ...
    @REPEAT:                     ; jump label
     ...
     LEA DX, MESSAGE3             ; load and display the string MESSAGE3
     MOV AH, 9
     INT 21H
